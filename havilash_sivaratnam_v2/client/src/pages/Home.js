...
import { ReactComponent as HomeSVG } from '../media/home.svg';
...
export default function Home() {
  return (
    <div className='container flex justify-center items-center'>
        ...
        flex flex-row justify-around items-center gap-20'>  {/* TODO change to grid */}
          <div>
          ...
          <HomeSVG className="fill-main-color-500 w-[300%]"/>
        </div>
    </div>
  )
}